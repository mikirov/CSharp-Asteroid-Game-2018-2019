...
public abstract class Spawner: MonoBehaviour {
    ...
    protected GameObject PlayerShip = null;
    PlayableGridCell[,] PlayableAreaGrid = null;
    protected bool IsSpawningFinished = false;
    ...
    protected void SpawnNewPrefabs()
    {
        ...
        {
            GameObject prefab = Instantiate(Prefab, Positions[i], Random.rotation);
            SetupObject(prefab);
        }
        CurrentCount = (uint)Positions.Count;
    }
    protected abstract void SetupObject(GameObject prefab);
